...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Service Animation
        gsap.utils.toArray(".service-item-wrap-2 .service-item-2").forEach((element, index, array) => {
        ...
        function scrollTopPercentage() {
            const scrollPercentage = () => {
                ...
                scrollElementWrap.css("background", `conic-gradient( var(--cp-color-common-white) ${scrollValue}%, var(--cp-color-theme-primary) ${scrollValue}%)`);
